...
MESSAGE_DEF(NAS_REGISTRATION_REQ,       MESSAGE_PRIORITY_MED,       NasRegistrationReq,         nas_registration_req)
MESSAGE_DEF(NAS_REG_REQ_IND,            MESSAGE_PRIORITY_MED,       NasRegistrationReqInd,      nas_reg_req_ind)
