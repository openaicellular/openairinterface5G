...
static void fill_harq_IEs(NR_ServingCellConfig_t *scc, int num_dlharq, int num_ulharq)
{
  ...
  switch (num_dlharq) {
    ...
    case 32:
      ...
      pdsch_scc->ext3->nrofHARQ_ProcessesForPDSCH_v1700 = calloc(1, sizeof(long));
      *pdsch_scc->ext3->nrofHARQ_ProcessesForPDSCH_v1700 =
      ...
      if (dlbwp && dlbwp->pdsch_Config &&
        ...
        dlcfg->ext3->harq_ProcessNumberSizeDCI_1_1_r17 = calloc(1, sizeof(long));
        *dlcfg->ext3->harq_ProcessNumberSizeDCI_1_1_r17 = 5;
      }
      int num_dl_bwp = 0;
  ...
  if (num_ulharq == 32) {
    ...
    if (!pusch_scc->ext3->nrofHARQ_ProcessesForPUSCH_r17)
      pusch_scc->ext3->nrofHARQ_ProcessesForPUSCH_r17 = calloc(1, sizeof(long));
    *pusch_scc->ext3->nrofHARQ_ProcessesForPUSCH_r17 = NR_PUSCH_ServingCellConfig__ext3__nrofHARQ_ProcessesForPUSCH_r17_n32;
    ...
    if (ulbwp && ulbwp->pusch_Config &&
      ...
      ulcfg->ext2->harq_ProcessNumberSizeDCI_0_1_r17 = calloc(1, sizeof(long));
      *ulcfg->ext2->harq_ProcessNumberSizeDCI_0_1_r17 = 5;
    }
    int num_ul_bwp = 0;
                            ...
                            const NR_ServingCellConfigCommon_t *scc)
{
  ...
  if (uecap && uecap->featureSets && uecap->featureSets->featureSetsUplinkPerCC
    ...
    if (!uplinkConfig->pusch_ServingCellConfig->choice.setup->ext1->maxMIMO_Layers)
      uplinkConfig->pusch_ServingCellConfig->choice.setup->ext1->maxMIMO_Layers =
                                                     ...
                                                     int uid)
{
  ...
  *secondaryCellGroup->spCellConfig->servCellIndex = servCellIndex;
  ...
  if (!pusch_scc->ext1->maxMIMO_Layers)
